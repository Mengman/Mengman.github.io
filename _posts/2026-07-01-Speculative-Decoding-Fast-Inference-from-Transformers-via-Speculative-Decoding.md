---
layout: post
title: 【投机解码专题论文笔记-核心论文】Fast Inference from Transformers via Speculative Decoding
date: 2026-07-01 00:00:00 +0800
categories: LLM Speculative-Decoding
typora-root-url: ..
---
...
![fig-1](/assets/Fast-Inference-from-Transformers-via-Speculative-Decoding/fig-1.png)
...
![alg-1](/assets/Fast-Inference-from-Transformers-via-Speculative-Decoding/alg-1.png)
...
![fig-2](/assets/Fast-Inference-from-Transformers-via-Speculative-Decoding/fig-2.png)

Figure 2 是以 \(\alpha\) 为横轴（范围 0~1），纵轴为 \(E(\# tokens)\)，并画出了不同 \(\gamma\)（1, 2, 3, 5, 7, \(\infty \)）下的曲线簇。从图2中可以获得两点启示：
...
![fig-3](/assets/Fast-Inference-from-Transformers-via-Speculative-Decoding/fig-3.png)
...
![table-2](/assets/Fast-Inference-from-Transformers-via-Speculative-Decoding/table-2.png)
...
![](/assets/Fast-Inference-from-Transformers-via-Speculative-Decoding/table-3.png)
